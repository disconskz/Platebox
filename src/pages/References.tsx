...
const NAV_GROUPS: { title: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "congrev_prices", title: "Конгрев", desc: "Тип конгрева (обычный/обратный/многоуровневый/3D/конгрев+фольга/микро/глубокий), допустимые материалы, цена комплектного конгревного клише (матрица+пуансон) за см² и мин. стоимость клише, приладка, цена одного оттиска, базовый коэффициент сложности и коэффициенты по типу, материалу (кожа/кожзам), сложному совмещению и мелким элементам, мин. стоимость операции. Полная формула: (тираж × цена оттиска) × коэф. сложности + MAX(площадь × цена клише, мин. клише) + приладка. Используется для авто-расчёта операции «Конгрев» отдельно от обычного тиснения.", countKey: "congrev_prices" },
    ],
  },
  {
