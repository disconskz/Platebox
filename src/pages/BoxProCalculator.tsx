        ...
        <PageContainer>
          ...
          <div className="flex flex-col gap-4 min-w-0">
            ...
            <div className="space-y-3">
              {/* Как формируется цена — единый блок, общий с боковой панелью Calculator.
                  Когда калькулятор встроен в общий «Новый расчёт» — скрываем здесь,
                  чтобы не дублировать с сайдбаром (там показывается тот же блок). */}
              {!embedded && (
                <BoxPriceBreakdown result={result as BoxPriceResult} margin={margin} vatPercent={vatPercent} />
              )}
