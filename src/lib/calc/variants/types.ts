...
export const VARIABLE_LIST: { key: string; label: string; hint: string }[] = [
  ...
  { key: "печ_листов", label: "Печатных листов", hint: "С учётом приладки (нетто + приладка)" },
  { key: "закуп_листов", label: "Закупочных листов", hint: "Бумага для закупки" },
  { key: "кол_резов", label: "Резов на лист", hint: "Резов на одном печатном листе (общий итог = × печ_листов)" },
  ...
  { key: "приладка_тираж", label: "Тираж с приладкой", hint: "тираж + приладка × изд/лист (не складывать с печ_листов!)" },
];
